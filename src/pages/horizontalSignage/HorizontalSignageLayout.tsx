...
const TABS = [
  { to: "/sinalizacao-horizontal", label: "Aprender", icon: "📖", end: true },
  { to: "/sinalizacao-horizontal/catalogo", label: "Catálogo", icon: "🗂️", end: false },
  { to: "/sinalizacao-horizontal/quiz", label: "Quiz", icon: "❓", end: false },
];

export default function HorizontalSignageLayout() {
  return (
      ...
      <header className="sticky top-0 z-20 bg-asphalt-900/95 backdrop-blur border-b border-asphalt-800 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[11px] font-semibold uppercase tracking-widest text-signal-yellow">
              Módulo 1
            </p>
            <h1 className="truncate text-lg font-bold text-signal-white">Sinalização Horizontal</h1>
          </div>
        </div>
      </header>
